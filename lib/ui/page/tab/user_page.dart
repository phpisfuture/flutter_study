...
import 'package:study/config/resource_mananger.dart';
import 'package:study/config/router_manger.dart';
import 'package:study/generated/i18n.dart';
import 'package:study/provider/provider_widget.dart';
import 'package:study/ui/page/tab/home_page.dart';
import 'package:study/ui/widget/app_bar.dart';
import 'package:study/ui/widget/bottom_clipper.dart';
import 'package:study/view_model/coin_model.dart';
import 'package:study/view_model/login_model.dart';
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                            ...
                            child: Hero(
                              ...
                              child: ClipOval(
                                child: Image.asset(
                                    ...
                                    width: 80,
                                    height: 80,
                                    color: model.hasUser ? Theme.of(context) .accentColor.withAlpha(200) : Theme.of(context).accentColor.withAlpha(10),
                          ...
                          Column(
                            children: <Widget>[
                              Text(
                                model.hasUser ? model.user.nickname : S.of(context).toSignIn,
                                style: Theme.of(context).textTheme.title.apply(color: Colors.white.withAlpha(200))),
                              SizedBox(
                                height: 10,
                              ),
